...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      ...
      <Card className="glass w-full max-w-md animate-fade-in">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardDescription>
            Start growing your SaaS with your AI marketing team
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-white/10 bg-white/5 pl-10 pr-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
            </div>
